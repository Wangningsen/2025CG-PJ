...
if __name__ == "__main__":
    ...
    model_id = "/remote-home1/jjchen/2025CG-PJ_/Qwen3-1.7B" # Base model
    ...
    # Model - Load without quantization
    ...
    # Ensure point_encoder parameters are trainable
    ...
    # Trainer Args - Adjusted for full fine-tuning
    training_args = SFTConfig(
    output_dir="cad-recode-qwen3-full-finetune",
    num_train_epochs=2,
    per_device_train_batch_size=32, # INCREASE THIS
    per_device_eval_batch_size=32,  # INCREASE THIS (or match train)
    gradient_accumulation_steps=1, # DECREASE OR SET TO 1 if per_device_train_batch_size is large enough
    ...
    dataloader_num_workers=12, # ADD THIS for faster data loading
)

    # Create trainer without peft_config
    # 方法2：手动指定checkpoint路径
# 请根据你的实际checkpoint目录修改路径
    resume_from_checkpoint = "/remote-home1/jjchen/2025CG-PJ_/cad-recode-qwen3-full-finetune/checkpoint-42000"  # 指定具体的checkpoint
    ...
    # 开始训练，传入resume_from_checkpoint参数
    print("Starting training...")
    trainer.train(resume_from_checkpoint=resume_from_checkpoint)

    # Save the final model
    print("Saving final model...")
    trainer.save_model("cad-recode-finetuned-full")