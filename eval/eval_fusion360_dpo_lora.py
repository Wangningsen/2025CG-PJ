...
if __name__ == '__main__':
    ...
    #     torch_dtype=torch.bfloat16,
    # ).eval().to(device)
    MODEL_PATH="/remote-home1/jjchen/2025CG-PJ_/cad-recode-v1.5"
    TOKENIZER_PATH="/remote-home1/jjchen/2025CG-PJ_/Qwen2-1.5B"
    model, tokenizer, device = load_model_and_tokenizer(MODEL_PATH,"/remote-home1/jjchen/2025CG-PJ_/cad-recode-dpo-lr1e-05-final", TOKENIZER_PATH)
    ...
    with open("eval_results_128.json", "w") as f:
